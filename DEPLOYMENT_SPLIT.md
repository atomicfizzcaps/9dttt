...
│ - Assets        │         │ - Database      │
└─────────────────┘         └─────────────────┘
   9dttt.vercel.app     ninedttt.onrender.com
```
...
- `NODE_ENV` = `production`
- `PORT` = `10000`
- `FRONTEND_URL` = `https://9dttt.vercel.app` (your Vercel domain)
...
- Frontend: `https://9dttt.vercel.app/api/health`
...
- **Frontend**: <https://9dttt.vercel.app> (Vercel)
